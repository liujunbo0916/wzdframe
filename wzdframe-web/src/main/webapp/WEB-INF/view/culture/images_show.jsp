...
<body class="gray-bg">
	<div class="wrapper wrapper-content">
						...
						<div class="lightBoxGallery">
							<c:forEach items="${albumModel}" var="item">
									<div style="float:left;width: 170px; height: 136px;margin-left:40px;">
										<a  href="${SETTINGPD.IMAGEPATH}${item.resource_path}" style="position: relative;" 
											data-gallery=""> <img class="album_p" style="width: 160px; height: 106px;"
											src="${SETTINGPD.IMAGEPATH}${item.resource_path}">
										</a>
		...
		<div class="form-group">
            <div class="col-sm-4 col-sm-offset-5">
                <button class="btn btn-warning" type="button"  onclick="window.history.go(-1);"><i class="fa fa-check"></i>&nbsp;&nbsp;返    回&nbsp;&nbsp; </button>
            </div>
          </div>
	</div>
	<script type="text/javascript">
	  ...
	  var serverUrl = "/sys/culture/resource/uploadImg";
	</script>
	<!-- basic scripts -->
	<!-- 页面底部js¨ -->

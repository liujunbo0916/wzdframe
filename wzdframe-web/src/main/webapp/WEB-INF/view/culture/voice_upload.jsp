...
<body class="gray-bg"> 
	<form action="/sys/culture/resource/uploadVoice" method="post"
						...
						<div class="ibox-content">
	                            ...
	                            <div class="col-sm-6 b-r">
							  	<div class="form-group">
		    							<label class="col-sm-2 control-label"><font  color="red" size="3px"  style="font-weight: bold; font-style: italic;">*&nbsp;</font>音频标题：</label>
								  	...
								  	<div class="form-group">
		    							...
		    							<font  color="red" size="3px"  style="font-weight: bold; font-style: italic;">*&nbsp;</font>封面图片：</label>
		       						       	<div class="col-sm-8 ">
														<div class="fileupload fileupload-new"
															data-provides="fileupload">
															<div class="fileupload-new thumbnail"
																style="max-height: 200px;">
																<img src="${SETTINGPD.IMAGEPATH}${dataModel.resource_img}"
															...
															<div>
																<span class="btn btn-default btn-file"> <span
																	...
																	id="resource_img" name="resource_img" type="file" accept="image/*">
									...
									<div class="form-group">
									   <label class="col-sm-2 control-label"><font  color="red" size="3px"  style="font-weight: bold; font-style: italic;">*&nbsp;</font>音频文件（不可更改）：</label>
													<div class="col-sm-8">
														...
														<div class="fileupload fileupload-new"
															...
															<div>
																<span class="btn btn-default btn-file"> <span
																	class="fileupload-new">选择文件</span> <span
																	class="fileupload-exists">重选</span> <input
																	id="resource_path" name="resource_path" type="file"  accept="audio/mpeg">
																</span> <a href="#" class="btn btn-default fileupload-exists"
																	data-dismiss="fileupload">移除</a>
															</div>
														</div>

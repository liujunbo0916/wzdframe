					...
					<div class="row">
						<div class="col-xs-12">
								<form action="" name="userForm" id="userForm" method="post">
									<input type="hidden" name="book_know" id="book_know" value=""/>
									<input type="hidden" name="id" id="id" value="${site.id}"/>
									<div id="zhongxin" style="padding-top: 13px;">
									<table id="table_report" class="table table-striped table-bordered table-hover">
											<tr id="contents">
												<td style="width:95px;text-align: right;padding-top: 13px;"><font color="red" size="3px" style="font-weight:bold;font-style:italic;">*</font> 预约须知:</td>
												<td colspan="3"><script id="safe_know_desc" type="text/plain" style="width:100%;height:280px">${site.book_know}</script></td>
											</tr>
												<tr id="contents">

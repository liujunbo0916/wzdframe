...
<body class="gray-bg">
						...
						<div class="lightBoxGallery">
							<c:forEach items="${albumModel}" var="item">
									<div style="float:left;width: 170px; height: 136px;margin-left:40px;">
										...
										<span onclick="delGoodsImg('${item.album_id}');" class="delImg">移除</span>
									</div>
							</c:forEach>
	...
	<script type="text/javascript">
	  ...
	  var serverUrl = "/sys/goods/goods/uploadPugin";
	</script>
	<!-- basic scripts -->
	<!-- 页面底部js¨ -->
	...
	$("#imgNum").text(5-imgNum);
	  ...
	  function delGoodsImg(album_id){
		  bootbox.confirm("确定删除该图片？",function(result){
			  if(result){
				  Ajax.request("/sys/goods/goods/deleteImg",{"data":{"album_id":album_id},"success":function(data){
					  if(data.result == 200){
						  location.reload();
					  }else{

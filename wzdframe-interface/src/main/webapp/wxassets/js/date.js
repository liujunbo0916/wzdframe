	...
	function resetIndex(){
        ...
        function bindButton(){
            ...
            $("#dateconfirm").unbind('click').click(function () {	
            	var datestr = $("#yearwrapper ul li:eq("+indexY+")").html().substr(0,$("#yearwrapper ul li:eq("+indexY+")").html().length-1)+"年<br>"+
               ...
               /* $.ajax({
        			type : "post",
        			url : "/wechat/user/rebateInfo?userId=1&month=" +  $("#yearwrapper ul li:eq("+indexY+")").html().substr(0,$("#yearwrapper ul li:eq("+indexY+")").html().length-1)+"0"+$("#monthwrapper ul li:eq("+indexM+")").html().substr(0,$("#monthwrapper ul li:eq("+indexM+")").html().length-1),
        			dataType : "json",
        			complete : function() {

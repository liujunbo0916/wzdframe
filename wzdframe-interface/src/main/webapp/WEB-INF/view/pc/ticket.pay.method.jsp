    ...
    <div class="special-content" style="margin-bottom: 200px;">
        ...
        <div class=" good-info">
            ...
            <div class="row good-content">
                <div class="col-md-8 col item-left">
                    ${orderInfo.ticketName} <span style="font-size: 12px;">
                  
                    </span>
                </div>
                <div class="col-md-4 col item-right" style="    color: #fc9313;">x${orderInfo.quantity}</div>
            </div>
            <div class="row good-content-two">
                ...
                <div class="col-md-4 col item-right">应付金额：<span style="    color: #fc9313;">¥${orderInfo.orderMoney}</span></div>
            </div>
        </div>
...
<script type="text/javascript">
  ...
  function requestOrderPayStatus(orderStatus){
	  Ajax.request("/pay/scanSuccess",{"data":{'orderId':'${orderInfo.id}',"type":"ticket"},"success":function(data){
		  if(data.code == 200){
			  var data = data.data;
			  if(data.to_pay_status == 1){
				  ...
				  setTimeout(function(){
					  var orderInfo = {
							  type:'ticket',
							  id:data.id,
							  to_contact_mobile:data.to_contact_mobile,
							  ticket_order_no:data.ticket_order_no
					  }
